...
System Features and Functionality Table
Version 1.0

Purpose of this document: This table provides a consolidated, at-a-glance inventory of every feature Career Compass includes — from the Explorer-themed landing page and guided assessment modules to the scoring engine, PDF report generator, and session-handling safeguards. Each feature is paired with a short description and a build status (Planned/Implemented), allowing the development status of the entire system to be tracked in one place. This table doubles as a key deliverable for Chapter 4's "System Development and Design" section, summarizing the system's full capability set for readers who need the complete picture without reading every other Phase 4 document individually.
...
F-06	Academic Profile Module	Captures strand, year level, grades, and best subjects	Planned
F-07	Rule-Based Weighted Scoring Engine	Computes category and course match scores using the defined weight table	Planned
F-08	Static Course/Career Dataset	Reference data on 24 courses across 6 categories, including schools and career info	Planned
F-09	Ranked Results with Match Percentage	Displays top-matching category and ranked course list with % scores	Planned
